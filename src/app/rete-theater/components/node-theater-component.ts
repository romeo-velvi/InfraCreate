...
import { NodeTheaterTemplate } from './node-theater-template/node-theater-template.component';

export class NodeTheaterComponent extends Component implements AngularComponent {
