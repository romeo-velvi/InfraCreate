...
import { NetworkComposer } from './network-composer/network-composer.component';

export class NetworkComposerComponent extends Component implements AngularComponent {
  ...
  constructor() {
    ...
    this.data.component = NetworkComposer;
  }
